...
export const Disponible = () => {
	return(
		<div className="flex flex-col md:flex-row justify-center items-center mt-5">
		  ...
		  <div className="border dark:text-kanagawa-bg-lighter border-kanagawa-bg-dark  justify-center rounded-2xl m-4 px-4 bg-kanagawa-accent inline-flex items-center gap-2">
